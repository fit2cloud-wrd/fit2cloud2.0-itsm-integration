...
@Service
@Slf4j
public class LbConsumerService extends ResourceQueueConsumerAbstractStrategy {
    ...
    public ResourceTypeConstants getResourceType() {
        return ResourceTypeConstants.LOAD_BALANCER;
    }
...
//            }
            ...
            LbLtmVirtualRet lbLtmVirtualRet = JSONObject.parseObject(resourceMessage.getContent(), LbLtmVirtualRet.class);
            Asserts.notNull(lbLtmVirtualRet, "LbLtmVirtualRet with ID:" + resourceMessage.getResourceId());

//            provider.onLoadbalancerChanged(lbLtmVirtualRet, resourceMessage.getResourceOperation());
